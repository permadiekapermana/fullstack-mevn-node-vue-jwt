    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card card-warning">
                ...
                <font class="card-title" text-color="white">Info Detail Data Siswa Keluar</font>
                </div>
                <!-- /.card-header -->
                <!-- form start -->                
                <div class="card-body">
                    ...
                    <h5>H. REGISTRASI PESERTA DIDIK KELUAR</h5>
                    <div class="form-group">
  ...
  methods: {
    ...
    async viewSiswaKeluarById() {
      try {
        ...
        this.alasan = response.data.values.[0].alasan;
